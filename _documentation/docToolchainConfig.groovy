...
microsite.with {
    ...
    footerMail = 'mailto:dev@unblu.com'
    //
    // twitter account url
    footerTwitter = 'https://twitter.com/Unblu'
    //
    // Stackoverflow QA
    footerSO = ''
    //
    // Github Repository
    footerGithub = 'https://github.com/unblu/ucascade'
    //
    // Slack Channel
    footerSlack = ''
    //
    ...
    issueUrl = 'https://github.com/unblu/ucascade/issues'
    //
    // the base url for code files in github
    // Example: https://github.com/doctoolchain/doctoolchain/edit/master/src/docs
    branchSelector = 'edit/'+System.getenv("DTC_PROJECT_BRANCH")?:'blob/HEAD'
    gitRepoUrl = "https://github.com/unblu/ucascade/${branchSelector}/_documentation/src/docs"
    ...
    menu = ["tech-docs": 'Technical docs', "user-docs": 'User docs']
